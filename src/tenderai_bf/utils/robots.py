...
class RobotsChecker:
    ...
    def get_request_rate(self, url: str, user_agent: str = "*") -> tuple | None:
        ...
        try:
            ...
            logger.error("Error getting request rate", url=url, error=str(e))
            return None
    ...
    def _get_robots_parser(
        ...
        try:
            ...
            logger.debug("Loaded robots.txt", base_url=base_url, robots_url=robots_url)

            return rp

        except Exception as e:
            logger.error("Failed to load robots.txt", base_url=base_url, error=str(e))
...
def get_request_rate(url: str, user_agent: str = "*") -> tuple | None:
    """Get request rate from robots.txt.
...
def is_respectful_delay(
    current_delay: float, robots_delay: float | None = None
) -> bool:
